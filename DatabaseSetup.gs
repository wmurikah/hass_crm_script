...
const SCHEMAS = {
  ...
  Customers: {
    headers: ['customer_id', 'account_number', 'company_name', 'trading_name', 'customer_type', 'segment_id', 'country_code', 'currency_code', 'credit_limit', 'credit_used', 'payment_terms', 'tax_pin', 'registration_number', 'industry', 'website', 'status', 'onboarding_status', 'risk_score', 'risk_level', 'lifetime_value', 'relationship_owner_id', 'parent_customer_id', 'source', 'notes', 'created_by', 'oracle_customer_code', 'affiliate_code', 'email', 'phone', 'address', 'city', 'created_at', 'updated_at'],
    validations: { status: ['ACTIVE', 'SUSPENDED', 'ON_HOLD', 'CLOSED', 'DELETED'], customer_type: ['B2B', 'B2C', 'GOVERNMENT'], risk_level: ['LOW', 'MEDIUM', 'HIGH'], onboarding_status: ['PENDING', 'IN_PROGRESS', 'COMPLETE', 'COMPLETED'] },
  },
  Contacts: {
